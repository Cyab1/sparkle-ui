...
import { RequestAccountDeletion } from "@/components/DeletionRequests";
    ...
    >
      ...
      <div className={`grid gap-5 ${isMobile ? "grid-cols-1" : "grid-cols-2"}`}>
        ...
        <div
          className="mk2-card"
          style={{
            borderTop: "2px solid hsl(0 84% 51%)",
        ...
        >
          ...
          <div className="text-xs text-muted-foreground mb-3 leading-relaxed">
            ...
            data, bookings, rewards and check-ins will be removed. Our team will
            process your request within 48 hours.
          </div>
          <button
            onClick={() => setShowDeleteAccount(true)}
            className="px-4 py-2.5 rounded-xl font-body font-bold text-sm cursor-pointer transition-all active:scale-95"
            style={{
