...
const CONTACT_INFO = [
  ...
  },
  {
    ...
    action: {
      label: "Visit website →",
      href: "https://www.mktworiversfitness.co.za/",
    },
  },
  {
    icon: "photo_camera",
...
export function Contact() {
  ...
  // Google Review URL from Firebase
  const [googleReviewUrl, setGoogleReviewUrl] = useState<string>("");

  useEffect(() => {
    get(ref(db, "admin_config/googleReviewUrl")).then((snap) => {
      if (snap.exists()) setGoogleReviewUrl(snap.val());
    });
  }, []);
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Google Review Link - loaded from Firebase */}
        <div className="mt-5 pt-3 text-center border-t border-border">
          {googleReviewUrl && (
            <a
...
//         {/* ───────────────────────────────────────────────────────────── */}
//         {/* GOOGLE REVIEW LINK - REPLACE href WITH YOUR ACTUAL REVIEW URL */}
//         {/* ───────────────────────────────────────────────────────────── */}
//         <div className="mt-5 pt-3 text-center border-t border-border">
//           <a
//             href="https://g.page/r/your-review-link" // 🔁 REPLACE with your actual Google Maps review URL (e.g., https://g.page/r/ABC123/review)
//             target="_blank"
//             rel="noopener noreferrer"
//             className="inline-flex items-center gap-1 text-sm font-bold transition-colors hover:opacity-80"
//             style={{ color: "hsl(217 91% 53%)" }}
