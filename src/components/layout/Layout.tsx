...
export function Layout({ children, page, setPage }: LayoutProps) {
  ...
  return (
    <div
      ...
      style={{
        // FIX: use safe-area-inset so iPhone home bar is accounted for
    ...
    >
      ...
      {/* ── Mobile top bar — FIX: safe area for notch */}
      {isMobile && (
        <div
      ...
      {/* ── Mobile bottom nav — FIX: safe area for iPhone home bar */}
      {isMobile && (
        <nav
